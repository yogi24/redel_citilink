...
import com.redel_citilink.redelga.service.AircraftService;
...
public class AircraftController {
    ...
    @RequestMapping(value="/{id:.+}/aircraftMtcSchedules", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the aircraftMtcSchedules instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<AircraftMtcSchedule> findAssociatedAircraftMtcSchedules(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated aircraftMtcSchedules");
        return aircraftService.findAssociatedAircraftMtcSchedules(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/aircraftUtilizationInfos", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the aircraftUtilizationInfos instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<AircraftUtilizationInfo> findAssociatedAircraftUtilizationInfos(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated aircraftUtilizationInfos");
        return aircraftService.findAssociatedAircraftUtilizationInfos(id, pageable);
    }

    @RequestMapping(value="/{id:.+}/redeliveryMatrixes", method=RequestMethod.GET)
    @ApiOperation(value = "Gets the redeliveryMatrixes instance associated with the given id.")
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Page<RedeliveryMatrix> findAssociatedRedeliveryMatrixes(@PathVariable("id") Integer id, Pageable pageable) {

        LOGGER.debug("Fetching all associated redeliveryMatrixes");
        return aircraftService.findAssociatedRedeliveryMatrixes(id, pageable);
    }
    ...
    public Page<TaskSchedule> findAssociatedTaskSchedules(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return aircraftService.findAssociatedTaskSchedules(id, pageable);
    }
