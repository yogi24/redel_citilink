 ...
 * @see AircraftType
 */
@Service("redelga.AircraftTypeService")
@Validated
public class AircraftTypeServiceImpl implements AircraftTypeService {
    ...
    @Autowired
    @Qualifier("redelga.AircraftTypeDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service redelga for table AircraftType to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service redelga for table AircraftType to {} format", options.getExportType());
